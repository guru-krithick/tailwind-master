...
export default function PlaygroundPage() {
  ...
  // Simplified initial HTML code for the playground - with dark mode support
  const initialHtml = `<header class="border-b border-gray-200 dark:border-gray-800 sticky top-0 bg-white/95 dark:bg-gray-950/95 backdrop-blur-sm z-10 shadow-sm">
...
<main class="container mx-auto px-4 py-12">
  ...
  // Initial CSS showcasing Tailwind v4 features with dark mode support
